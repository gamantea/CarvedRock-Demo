...
namespace CarvedRock.UITests
{
    ...
    public class AndroidUITests
    {
        ...
        private void CreateScreenshot(AndroidDriver<AppiumWebElement>  driver)
        {
        ...
        private AndroidDriver<AppiumWebElement> StartApp()
        {
            ...
            capabilities.AddAdditionalCapability(AndroidMobileCapabilityType.Avd, "pixel_2_xl_pie_9_0_-_api_28");
            ...
            // specifying which app we want to install and launch
